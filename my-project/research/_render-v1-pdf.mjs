...
await p.goto('file:///home/user/Outreach/my-project/research/animaccord-business-model-v1.html', { waitUntil:'networkidle' });
...
await p.pdf({
  path:'/home/user/Outreach/my-project/research/animaccord-business-model-v1.pdf',
  ...
  footerTemplate:`<div style="width:100%;font-family:'IBM Plex Mono',monospace;font-size:7pt;color:#767F7A;padding:0 12mm;display:flex;justify-content:space-between;">
    <span>Что должно происходить с пользователем после покупки за $100 · Animaccord · август 2026</span>
