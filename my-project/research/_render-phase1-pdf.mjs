...
const OUT = '/home/user/Outreach/my-project/research/phase1-own-funds.pdf';
const b = await chromium.launch({ executablePath: '/opt/pw-browsers/chromium' });
const p = await b.newPage({ colorScheme: 'light' });
await p.goto('file:///home/user/Outreach/my-project/research/phase1-own-funds.html', { waitUntil: 'networkidle' });
...
await p.pdf({
  ...
  footerTemplate: `<div style="width:100%;font-family:'IBM Plex Mono',monospace;font-size:7pt;color:#767F7A;padding:0 15mm;display:flex;justify-content:space-between;">
    <span>Фаза 1 на $200 тысяч · Animaccord · август 2026</span>
